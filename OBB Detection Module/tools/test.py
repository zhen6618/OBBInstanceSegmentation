...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='../runs/train/oriented_rcnn_original/epoch_20.pth')
    parser.add_argument('--work-dir', default='../runs/test/oriented_rcnn_original')
    parser.add_argument('--show-dir', default='../runs/test/oriented_rcnn_original/images')
    parser.add_argument(
        '--eval',
        default='mAP',
        type=str,
