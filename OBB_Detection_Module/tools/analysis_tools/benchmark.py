...
def parse_args():
    ...
    # configs/roi_trans/roi_trans_r50_fpn_1x_dota_le90_original.py
    # configs/oriented_rcnn/oriented_rcnn_r50_fpn_1x_dota_le90_original.py
    # configs/gliding_vertex/gliding_vertex_r50_fpn_1x_dota_le90_original.py

    parser.add_argument('--config', default='configs/gliding_vertex/gliding_vertex_r50_fpn_1x_dota_le90_original.py')
    parser.add_argument('--checkpoint', default='runs/train/gliding_vertex_original/latest.pth')
    parser.add_argument(
        '--repeat-num',
        type=int,
        default=1,
